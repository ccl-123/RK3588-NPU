...
- **OpenAI-Compatible Remote LLM**: Remote mode calls an OpenAI-compatible `/v1/chat/completions` backend configured by `LLAMA_CPP_SERVER_URL`.
...
- `LLAMA_CPP_SERVER_URL` is required for remote Agent traffic
